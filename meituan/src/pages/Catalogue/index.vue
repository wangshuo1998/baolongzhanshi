          ...
          <ul>
            ...
            <li class="firstItem">
              ...
              <ul v-show="currentFlag === '1-1'">
                ...
                <a href="javascript:;" class="secondItem">团购业务</a>
                <a href="javascript:;" class="secondItem">小象生鲜</a>
                <a href="javascript:;" class="secondItem">美团买菜</a>
                <a href="javascript:;" class="secondItem">美团打车</a>
              </ul>
            </li>
